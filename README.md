...
```javascript
dsmeanpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dsmeanpn@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dsmeanpn/tags). For example,

```javascript
dsmeanpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dsmeanpn@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dsmeanpn = require( 'path/to/vendor/umd/stats-strided-dsmeanpn/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dsmeanpn@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dsmeanpn.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dsmeanpn

[test-image]: https://github.com/stdlib-js/stats-strided-dsmeanpn/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-dsmeanpn/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dsmeanpn/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dsmeanpn?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dsmeanpn.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dsmeanpn/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-dsmeanpn/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-dsmeanpn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-dsmeanpn/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-dsmeanpn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-dsmeanpn/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-dsmeanpn/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-dsmeanpn/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dsmeanpn/main/LICENSE
